...
namespace thehomebrewapi.Helpers
{
    ...
    {
        private static IDataManipulation defaultImplementation = new DataManipulation();
        public static IDataManipulation Implementation { get; set; } = defaultImplementation;
        ...
        public static ExpandoObject ShapeData<TSource>(this TSource source,
            string fields)
        {
            return Implementation.ShapeData(source, fields);
        }
